...
public class GameTest {
    ...
    public static void main(String[] args) {
        ...
        GameObjects.getInstance().setMainCamera(new MultipleCamera(new GameObject[]{GameObjects.getInstance().findObject("o1"), GameObjects.getInstance().findObject("o2")}, new Position(0, 0)));
