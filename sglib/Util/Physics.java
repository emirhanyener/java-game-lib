...
public class Physics {
    ...
    public void calculate() {
        ...
        LinkedList<GameObject> detectedObjectsRight = object.checkTrigger(0, 0,
                (object.size.getWidth() / 2) + object.velocity.getX(), 0, Setting.VELOCITY_GUI_ACTIVE, "right");
        LinkedList<GameObject> detectedObjectsLeft = object.checkTrigger(0, 0,
                (-1) * (object.size.getWidth() / 2) + object.velocity.getX(), 0, Setting.VELOCITY_GUI_ACTIVE, "left");
        LinkedList<GameObject> detectedObjectsRightDown = object.checkTrigger((object.size.getWidth() / 2), 0, 0,
                (object.size.getHeight() / 2) + object.velocity.getY() + 10, Setting.VELOCITY_GUI_ACTIVE, "rdown");
        LinkedList<GameObject> detectedObjectsLeftDown = object.checkTrigger((-1) * (object.size.getWidth() / 2), 0, 0,
                (object.size.getHeight() / 2) + object.velocity.getY() + 10, Setting.VELOCITY_GUI_ACTIVE, "ldown");
        LinkedList<GameObject> detectedObjectsDownDown = object.checkTrigger((-1) * (object.size.getWidth() / 2),
                (object.size.getHeight() / 2) + object.velocity.getY() + 10, object.size.getWidth(), 0,
        ...
        LinkedList<GameObject> detectedObjectsRightUp = object.checkTrigger((object.size.getWidth() / 2), 0, 0,
                (-1) * (object.size.getHeight() / 2) + object.velocity.getY(), Setting.VELOCITY_GUI_ACTIVE, "rup");
        LinkedList<GameObject> detectedObjectsLeftUp = object.checkTrigger((-1) * (object.size.getWidth() / 2), 0, 0,
                (-1) * (object.size.getHeight() / 2) + object.velocity.getY(), Setting.VELOCITY_GUI_ACTIVE, "lup");
        LinkedList<GameObject> detectedObjectsUpUp = object.checkTrigger((-1) * (object.size.getWidth() / 2),
                (-1) * (object.size.getHeight() / 2) + object.velocity.getY(), object.size.getWidth(), 0,
        ...
        if(this.isGround) {
            if(Math.abs(object.velocity.getX()) > 0.0000000001f){
                object.velocity.addX((-1) * object.velocity.getX() / 10);
            } else {
                object.velocity.setX(0);
            }
        } else {
            if(Math.abs(object.velocity.getX()) > 0.0000000001f){
                object.velocity.addX((-1) * object.velocity.getX() / 100);
            } else {
                object.velocity.setX(0);
            }
        }
